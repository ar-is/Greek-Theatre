...
namespace GreekTheater.WebApp
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<TheaterWebAppDbContext>(options =>
            {
                options.UseSqlServer(@"Server=(localdb)\mssqllocaldb;Database=TheaterWebAppDb;Trusted_Connection=True;");
            });

            services.AddDefaultIdentity<ApplicationUser>(options => options.SignIn.RequireConfirmedAccount = true)
                .AddEntityFrameworkStores<TheaterWebAppDbContext>()
                .AddDefaultUI()
